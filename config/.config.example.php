...
$_ENV['baseUrl'] = 'http://websiteurl';					//站点地址
...
$_ENV['db_database'] = 'sspanel-db-databasename';						//数据库名
$_ENV['db_username'] = 'sspanel-db-username';							//数据库用户名
$_ENV['db_password'] = 'sspanel-db-password';						//用户名对应的密码
...
$_ENV['reg_method']='chacha20';						//注册时默认加密方式
$_ENV['reg_protocol']='auth_aes128_sha1';					//注册时默认协议
$_ENV['reg_protocol_param']='';					//注册时默认协议参数
$_ENV['reg_obfs']='tls1.2_ticket_auth';							//注册时默认混淆方式
